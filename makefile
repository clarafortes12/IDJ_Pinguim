all:
	g++ -Isdl/Include -Lsdl/lib -o jogo src/main.cpp src/Game.cpp src/State.cpp src/Sprite.cpp src/Music.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf
...
#SDL_PATHS = D:/3-Faculdade/1-Semestres/9ºSemestre/IDJ/IDJ_Pinguim/SDL2
